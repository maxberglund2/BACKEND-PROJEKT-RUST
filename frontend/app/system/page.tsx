    ...
    <div className="min-h-screen bg-gradient-to-br from-[#31364F] via-[#435663] to-[#31364F] relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <header className="p-6 flex justify-between items-center">
          ...
          >
            <CheckSquare
              className="text-[#A3B087] cursor-pointer"
              size={32}
              strokeWidth={2.5}
              onClick={() => router.push("/")}
            />
            <span
              className="text-2xl font-bold text-[#FFF8D4] tracking-tight cursor-pointer"
              onClick={() => router.push("/")}
            >
              SystemFlow
            </span>
          ...
          >
            <button className="px-5 py-2 text-[#FFF8D4] hover:text-white transition-colors font-medium">
              Sign In
            </button>
            <button className="px-5 py-2 bg-[#A3B087] text-[#31364F] rounded-lg hover:bg-[#b5c59a] transition-all font-semibold shadow-lg hover:shadow-xl hover:scale-105">
              Sign Up
            </button>
          </div>
        </header>
                ...
                >
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    {!system.is_default && (
                      <button
                        onClick={() =>
                          handleDelete(system.id, system.is_default)
                        }
